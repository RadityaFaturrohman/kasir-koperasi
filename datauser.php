...
<html lang="en">
    ...
    <body data-topbar="dark" data-sidebar="white" data-layout-mode="white">
...
<div class="create">
     <a href="user.html" class="text-create">CREATE</a>
 </div>
 ...
 <table  border="1"  class="table">
     ...
     while($data = mysqli_fetch_array($query)){
         ...
         <tr>
             ...
             <div class='kotakaja'><a href='formuser.php?id=".$data['id_user']."' class='button'>Edit</a></div>
