                                                    ...
                                                    <div class="card dash-product-box shadow-none border mb-0">
                                                        <div class="card-body">
                                                           ...
                                                           <div class="dash-product-img">
                                                             <img src="assets/images/product/gmt-master.png" class="img-fluid" alt="">
                                                           </div>
    
                                                            <h5 class="font-size-17 mt-1">
                                                                <a href="ecommerce-product-detail.html" class="text-dark lh-base">Rolex GMT Master II</a>
                                                            </h5>
    
                                                            <h5 class="font-size-20 text-primary mt-3 mb-0">$30.000</h5>
                                                    ...
                                                    <div class="card dash-product-box shadow-none border mb-0">
                                                        <div class="card-body">
                                                            <div class="dash-product-img">
                                                               ...
                                                               <h5 class="font-size-17 mt-1">
                                                                   <a href="ecommerce-product-detail.html" class="text-dark lh-base">New Oyster Perpetual Roller</a>
                                                               </h5>
       
                                                               <h5 class="font-size-20 text-primary mt-3 mb-0">$16.000</h5>
                                                    ...
                                                    <div class="card dash-product-box shadow-none border mb-0">
                                                          <div class="card-body">
                                                            <div class="dash-product-img">
                                                               ...
                                                               <h5 class="font-size-17 mt-1">
                                                                   <a href="ecommerce-product-detail.html" class="text-dark lh-base">Rolex Sea Dweller</a>
                                                               </h5>
      
                                                               <h5 class="font-size-20 text-primary mt-3 mb-0">$17.000</h5>
                                                    ...
                                                    <div class="card dash-product-box shadow-none border mb-0">
                                                          <div class="card-body">
                                                            <div class="dash-product-img">
                                                               ...
                                                               <h5 class="font-size-17 mt-1">
                                                                   <a href="ecommerce-product-detail.html" class="text-dark lh-base">Cosmograph Daytona</a>
                                                               </h5>
      
                                                               <h5 class="font-size-20 text-primary mt-3 mb-0">$75.000</h5>
