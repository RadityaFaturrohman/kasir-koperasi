   ...
   <div class="main-content">
                ...
                <?php
                    ...
                    while($barang = mysqli_fetch_array($query)){
                        ...
                        echo "<a class='btn btn-outline-info action-btn' href=formedit.php?id_user=".$barang['id_user'].">Edit</a> | ";
                        echo "<a class='btn btn-outline-danger action-btn' href=delete.php?id_user=".$barang['id_user'].">Delete</a>";
                        echo "</td>";
                        echo "</tr>";
                    }
                    ?>
